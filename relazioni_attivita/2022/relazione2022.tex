...
\newcites{all}{Lista di tutte le altre pubblicazioni dal 2018 al 2022}
...
\hspace*{-0.6cm}{ L'attivit\`a da me svolta dal 1 Aprile 2018 ad oggi
  ...
  valore massimo durante il Run2.  Il funzionamento dell'algoritmo \`e
  anche stato dimostrato su simulazioni fino a una media di 200
  ...
  su \textit{JINST} su questo~\citemain{sp_CMS:2020xlg}. Sempre nell'ambito
  delle prestazioni di ECAL, mi sono occupato personalmente della
  ...
  differenziali~\citemain{sp_CMS:2021kom}, alla prima misura della produzione
  ...
  precedentemente partecipato~\citemain{sp_CMS:2021nnc}.
  ...
  particella~\citemain{sp_CMS:2022ley} e l'articolo pubblicato sulla rivista
  ...
  stesso~\citemain{sp_CMS:2022dwd}.
  ...
  dell'esperimento CYGNO~\citemain{sp_Pinci:2019ztr}, un rivelatore per la
  ...
  sorgenti radioattive, quali il $^{55}$Fe~\citemain{sp_Costa:2019tnu}, ma
