...
\hspace*{-0.6cm}{ L'attivit\`a da me svolta dal 1 Aprile 2018 ad oggi
  ...
  fattibilit\`a a un primo prototipo in grado di prendere dati ai {\it
    Laboratori Nazionali del Gran Sasso}, esperimento {\it CYGNO}.
  ...
  maggiore frequenza di campionamento dell'impulso. Ho scritto un
  articolo pubblicato su \textit{JINST} su
  questo~\cite{CMS:2020xlg}. Nello stesso ambito, mi sono occupato
  personalmente della calibrazione della risposta in energia dei
  cristalli mediante la risonanza $\pi^0\to\gamma\gamma$, e questi
  input sono stati fondamentali nelle analisi del bosone di Higgs nei
  decadimenti in due fotoni~\cite{CMS:2020xrn}, ma anche per tutte le
  analisi di CMS che, per i risultati aggiornati all'intero data set
  di Run-2 (${\cal L}_{\rm int}=137\,{\rm fb}^{-1}$), hanno utilizzato
  la ricostruzione cosiddetta {\it Ultra-Legacy}. Sempre in questo
  ambito, dal 2021, mi sto occupando del progetto di upgrade del
  sistema di HV degli APD di ECAL, per quanto riguarda il rifacimento
  dei cavi e di tutte le schede che contengono i canali HV (lato
  tecnico e setup dell'eventuale gara per la fornitura), per un
  graduale rimpiazzo degli stessi entro l'inizio della fase-2 di LHC
  (HL-LHC).
...
\bibliographymain{relazione2022}
